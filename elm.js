...
var _user$project$Route$Projects = {ctor: 'Projects'};
...
var _user$project$Route$route = _evancz$url_parser$UrlParser$oneOf(
	{
		...
		_1: {
			...
			_1: {
				...
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$Route$Projects,
					_evancz$url_parser$UrlParser$s('projects')),
				_1: {
					ctor: '::',
					_0: A2(
						_evancz$url_parser$UrlParser$map,
						_user$project$Route$Resume,
						_evancz$url_parser$UrlParser$s('resume')),
					_1: {
						ctor: '::',
						_0: A2(
							_evancz$url_parser$UrlParser$map,
							_user$project$Route$Contact,
...
var _user$project$Page_Header$styles = function (_p0) {
	return _elm_lang$html$Html_Attributes$style(
		_rtfeldman$elm_css$Css$asPairs(_p0));
};
var _user$project$Page_Header$profilePic = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _user$project$Page_Header$styles(
			{
				ctor: '::',
	...
	},
	{
		...
		_0: A2(
			_elm_lang$html$Html$img,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$src('imgs/profile.jpg'),
					_1: {ctor: '[]'}
				}
			},
			{ctor: '[]'}),
...
var _user$project$Page_Header$tallness = 54;
var _user$project$Page_Header$InternalModel = function (a) {
	return {selected: a};
};
var _user$project$Page_Header$Model = function (a) {
	return {ctor: 'Model', _0: a};
};
var _user$project$Page_Header$init = _user$project$Page_Header$Model(
	{selected: 'Home'});
var _user$project$Page_Header$update = F2(
	function (msg, _p1) {
		var _p2 = _p1;
		var _p3 = msg;
		return _user$project$Page_Header$Model(
			_elm_lang$core$Native_Utils.update(
				_p2._0,
				{selected: _p3._0}));
	});
var _user$project$Page_Header$Select = function (a) {
	return {ctor: 'Select', _0: a};
};
var _user$project$Page_Header$button = F3(
	function (currentRoute, page, str) {
		var textColor = _elm_lang$core$Native_Utils.eq(currentRoute, page) ? _rtfeldman$elm_css$Css$color(
			A3(_rtfeldman$elm_css$Css$hsl, 0, 0, 0)) : _rtfeldman$elm_css$Css$color(
			A3(_rtfeldman$elm_css$Css$hsl, 189, 0.55, 0.61));
		var background = _elm_lang$core$Native_Utils.eq(currentRoute, page) ? A3(
			_rtfeldman$elm_css$Css$borderBottom3,
			_rtfeldman$elm_css$Css$px(1),
			_rtfeldman$elm_css$Css$solid,
			A3(_rtfeldman$elm_css$Css$hsl, 0, 0, 0)) : _rtfeldman$elm_css$Css$backgroundColor(_rtfeldman$elm_css$Css$inherit);
		return A2(
			_elm_lang$html$Html$a,
			{
				ctor: '::',
				_0: _user$project$Route$href(page),
				_1: {
					ctor: '::',
					_0: _user$project$Page_Header$styles(
						{
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Page_Header$Select(str)),
						_1: {ctor: '[]'}
					}
				}
			},
...
var _user$project$Page_Header$homeButton = function (model) {
	return A3(_user$project$Page_Header$button, model, _user$project$Route$Home, 'Home');
};
var _user$project$Page_Header$aboutButton = function (model) {
	return A3(_user$project$Page_Header$button, model, _user$project$Route$About, 'About');
};
var _user$project$Page_Header$projectsButton = function (model) {
	return A3(_user$project$Page_Header$button, model, _user$project$Route$Projects, 'Projects');
};
var _user$project$Page_Header$resumeButton = function (model) {
	return A3(_user$project$Page_Header$button, model, _user$project$Route$Resume, 'Resume');
};
var _user$project$Page_Header$contactButton = function (model) {
	return A3(_user$project$Page_Header$button, model, _user$project$Route$Contact, 'Contact');
};
var _user$project$Page_Header$view = F2(
	function (route, _p4) {
		var _p5 = _p4;
		var _p6 = A2(
			_elm_lang$core$Debug$log,
			'(route, model)',
			{ctor: '_Tuple2', _0: route, _1: _p5._0});
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _user$project$Page_Header$styles(
					{
						...
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$backgroundColor(
								A4(_rtfeldman$elm_css$Css$hsla, 0, 0.0, 0.0, 0)),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
			...
			_elm_lang$core$List$reverse(
				{
					ctor: '::',
					_0: _user$project$Page_Header$homeButton(route),
					_1: {
						ctor: '::',
						_0: _user$project$Page_Header$aboutButton(route),
						_1: {
							ctor: '::',
							_0: _user$project$Page_Header$projectsButton(route),
							_1: {
								ctor: '::',
								_0: _user$project$Page_Header$resumeButton(route),
								_1: {
									ctor: '::',
									_0: _user$project$Page_Header$contactButton(route),
									_1: {
										ctor: '::',
										_0: _user$project$Page_Header$profilePic,
										_1: {ctor: '[]'}
									}
								}
							}
...
var _user$project$Page_Home$styles = function (_p0) {
	return _elm_lang$html$Html_Attributes$style(
		_rtfeldman$elm_css$Css$asPairs(_p0));
};
var _user$project$Page_Home$submarine = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('submarine-wrapper'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('submarine-body'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('engine'),
							_1: {ctor: '[]'}
						},
						{ctor: '[]'}),
					_1: {
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('helix'),
					_1: {ctor: '[]'}
				},
				{ctor: '[]'}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('hat'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('leds-wrapper'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('periscope'),
										_1: {ctor: '[]'}
									},
									{ctor: '[]'}),
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('leds'),
											_1: {ctor: '[]'}
										},
										{ctor: '[]'}),
									_1: {ctor: '[]'}
...
var _user$project$Page_Home$bubble = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('circle-wrapper'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('bubble'),
				_1: {ctor: '[]'}
			},
			{ctor: '[]'}),
		_1: {
			ctor: '::',
			_0: _user$project$Page_Home$submarine,
			_1: {ctor: '[]'}
		}
	});
var _user$project$Page_Home$submarinePaper = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('sea'),
		_1: {
			ctor: '::',
			_0: _user$project$Page_Home$styles(
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$height(
	...
	{
		ctor: '::',
		_0: _user$project$Page_Home$bubble,
		_1: {ctor: '[]'}
	});
var _user$project$Page_Home$view = F2(
	function (window, model) {
		return A2(
				...
				_0: _user$project$Page_Home$styles(
					{
						...
						_0: _rtfeldman$elm_css$Css$width(
							_rtfeldman$elm_css$Css$px(
								_elm_lang$core$Basics$toFloat(window.width))),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$height(
								_rtfeldman$elm_css$Css$px(
									_elm_lang$core$Basics$toFloat(window.height))),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
			...
			{
				ctor: '::',
				_0: _user$project$Page_Home$submarinePaper,
				_1: {ctor: '[]'}
			});
	});
...
var _user$project$Page_Home$init = {};
var _user$project$Page_Home$Model = {};
var _user$project$Page_Home$HeaderMsg = function (a) {
	return {ctor: 'HeaderMsg', _0: a};
};

var _user$project$Page_Helper$styles = function (_p0) {
	return _elm_lang$html$Html_Attributes$style(
		_rtfeldman$elm_css$Css$asPairs(_p0));
};
var _user$project$Page_Helper$topImage = F2(
...
var _user$project$Page_Helper$topImageView = F3(
	function (window, topImage, body) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
...
var _user$project$Page_About$styles = function (_p0) {
	return _elm_lang$html$Html_Attributes$style(
		_rtfeldman$elm_css$Css$asPairs(_p0));
};
var _user$project$Page_About$p = function (str) {
	return A2(
...
var _user$project$Page_About$about = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
	...
	{
		ctor: '::',
		_0: _user$project$Page_About$p('Like most kids in the U.S., I went to school on the usual five day a week track for many years. I always enjoyed learning something new. Even more than that, I loved sharing that new piece of knowledge with those around me. If I learned something new at school, I would share it at home. If I learned something new at home, I would share it at school.'),
		_1: {
			ctor: '::',
			_0: _user$project$Page_About$p('Slowly, school became less interesting to me. I was starting to do more tedious tasks. I didn\'t feel like I was learning as much anymore. The joy I had faded. I knew there had to be a better way to teach. I knew there had to be a better way to learn. I was going to figure out that way.'),
			_1: {
				ctor: '::',
				_0: _user$project$Page_About$p('From an early age, I grew a strong desire to improve education. Continuing through schooling, that desire only became stronger.'),
				_1: {
					ctor: '::',
					_0: _user$project$Page_About$p('When in college I decided on Computer Science as a major because I felt I could have the widest reach with this if I were to make any impact on education. I was lucky enough to get into the software industry straight out of college, but after a few years in the software industry, I do not feel anywhere close to my education goal.'),
					_1: {
						ctor: '::',
						_0: _user$project$Page_About$p('I have come to learn that I need many years to make a quality educational game. It is challenging figuring out exactly how to structure a game, how to make a game enticing, how to make a game stick so people keep coming back, how to make that perfect educational game. I have some basic ideas of keeping the game simple, making it intuitive, having the learning being secondary to the task. But putting these things into practice and figuring out  all the little details of a game is extremely difficult.'),
						_1: {
							ctor: '::',
...
var _user$project$Page_About$crossBackground = {
	ctor: '::',
	_0: A2(_rtfeldman$elm_css$Css$property, 'background', 'radial-gradient(circle, transparent 20%, slategray 20%, slategray 80%, transparent 80%, transparent), radial-gradient(circle, transparent 20%, slategray 20%, slategray 80%, transparent 80%, transparent) 50px 50px, linear-gradient(#A8B1BB 8px, transparent 8px) 0 -4px, linear-gradient(90deg, #A8B1BB 8px, transparent 8px) -4px 0'),
	_1: {
		ctor: '::',
		_0: A2(_rtfeldman$elm_css$Css$property, 'backgroundColor', 'slategray'),
		_1: {
			ctor: '::',
			_0: A2(_rtfeldman$elm_css$Css$property, 'backgroundSize', '100px 100px, 100px 100px, 50px 50px, 50px 50px'),
			_1: {ctor: '[]'}
		}
	}
};
var _user$project$Page_About$topImage = A2(_user$project$Page_Helper$topImage, 'imgs/notebook.svg', _user$project$Page_About$crossBackground);
var _user$project$Page_About$view = F2(
	function (window, model) {
		return A3(_user$project$Page_Helper$topImageView, window, _user$project$Page_About$topImage, _user$project$Page_About$about);
	});
var _user$project$Page_About$update = F2(
	function (msg, model) {
		return model;
	});
var _user$project$Page_About$init = {};
var _user$project$Page_About$Model = {};
var _user$project$Page_About$HeaderMsg = function (a) {
	return {ctor: 'HeaderMsg', _0: a};
};

var _user$project$Page_Projects$styles = function (_p0) {
	return _elm_lang$html$Html_Attributes$style(
		_rtfeldman$elm_css$Css$asPairs(_p0));
};
var _user$project$Page_Projects$project = F3(
	function (title, href, description) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('projectListItem'),
				_1: {
					ctor: '::',
...
var _user$project$Page_Projects$carbonFibreBackground = {
	...
	_1: {
		ctor: '::',
		_0: A2(_rtfeldman$elm_css$Css$property, 'backgroundColor', '#282828'),
		_1: {
			ctor: '::',
			_0: A2(_rtfeldman$elm_css$Css$property, 'backgroundSize', '16px 16px'),
			_1: {ctor: '[]'}
		}
	}
};
...
var _user$project$Page_Projects$init = {};
var _user$project$Page_Projects$Model = {};
var _user$project$Page_Projects$HeaderMsg = function (a) {
	return {ctor: 'HeaderMsg', _0: a};
};

var _user$project$Page_Resume$styles = function (_p0) {
	return _elm_lang$html$Html_Attributes$style(
		_rtfeldman$elm_css$Css$asPairs(_p0));
};
var _user$project$Page_Resume$resume = function (window) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _user$project$Page_Resume$styles(
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$padding(
						_rtfeldman$elm_css$Css$px(10)),
						...
						_0: _user$project$Page_Resume$styles(
							{
								...
								_0: _rtfeldman$elm_css$Css$width(
									_rtfeldman$elm_css$Css$px(
										_elm_lang$core$Basics$toFloat(window.width) - 60)),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$height(
										_rtfeldman$elm_css$Css$px(
											_elm_lang$core$Basics$toFloat(window.height) - 110)),
									_1: {
										ctor: '::',
										_0: A2(_rtfeldman$elm_css$Css$property, 'frameborder', '0'),
										_1: {ctor: '[]'}
									}
								}
							}),
...
var _user$project$Page_Resume$view = F2(
	function (window, model) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				ctor: '::',
				_0: _user$project$Page_Resume$resume(window),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Page_Resume$update = F2(
	function (msg, model) {
		return model;
	});
var _user$project$Page_Resume$init = {};
var _user$project$Page_Resume$Model = {};
var _user$project$Page_Resume$HeaderMsg = function (a) {
	return {ctor: 'HeaderMsg', _0: a};
};

var _user$project$Page_Contact$styles = function (_p0) {
	return _elm_lang$html$Html_Attributes$style(
		_rtfeldman$elm_css$Css$asPairs(_p0));
};
...
var _user$project$Page_Contact$init = {};
var _user$project$Page_Contact$Model = {};
var _user$project$Page_Contact$HeaderMsg = function (a) {
	return {ctor: 'HeaderMsg', _0: a};
};
...
var _user$project$Main$background = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$src('imgs/giraffe.svg'),
		_1: {ctor: '[]'}
	},
	{ctor: '[]'});
...
var _user$project$Main$Contact = function (a) {
	return {ctor: 'Contact', _0: a};
};
var _user$project$Main$Resume = function (a) {
	return {ctor: 'Resume', _0: a};
};
var _user$project$Main$Projects = function (a) {
	return {ctor: 'Projects', _0: a};
};
...
var _user$project$Main$initialModel = {
	...
	header: _user$project$Page_Header$init,
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		var headerUpdate = function (newHeader) {
			return A2(
				_user$project$Util_ops['=>'],
				_elm_lang$core$Native_Utils.update(
					model,
...
var _user$project$Main$ResumeMsg = function (a) {
	return {ctor: 'ResumeMsg', _0: a};
};
var _user$project$Main$ProjectsMsg = function (a) {
	return {ctor: 'ProjectsMsg', _0: a};
};
	...
	return A2(
			...
			_0: _user$project$Main$styles(
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$backgroundColor(
						A4(_rtfeldman$elm_css$Css$hsla, 0, 0, 1, 0.85)),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$width(
							_rtfeldman$elm_css$Css$px(
								_elm_lang$core$Basics$toFloat(model.window.width))),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$height(
								_rtfeldman$elm_css$Css$px(
									_elm_lang$core$Basics$toFloat(model.window.height - _user$project$Page_Header$tallness))),
							_1: {ctor: '[]'}
						}
					}
				}),
		...
		},
		{
			...
			_0: A2(
				...
				A2(_user$project$Page_Header$view, model.route, model.header)),
			_1: {
				ctor: '::',
				_0: page,
				_1: {ctor: '[]'}
